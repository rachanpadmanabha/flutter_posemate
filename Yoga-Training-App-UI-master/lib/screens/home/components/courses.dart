...
class Courses extends StatelessWidget {
  ...
  Courses(this.selectedIconIndex);
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(course.students,style: TextStyle(color: black.withOpacity(0.3),fontFamily: 'TitilliumWeb'),)
                        ],
                      ),
                      SizedBox(
                        height: size.height * 0.01,
                      ...
                      Row(
                        children: [
                          ...
                          Text(course.time.toString() + ' min',style: TextStyle(color: black.withOpacity(0.3),fontFamily: 'TitilliumWeb'),)
                        ],
                      ),
                    ],
                  ),
